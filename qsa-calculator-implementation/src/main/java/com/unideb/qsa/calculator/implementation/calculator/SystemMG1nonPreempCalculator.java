...
public class SystemMG1nonPreempCalculator {
    ...
    public double WAvg2(Map<SystemFeature, Double> features) {
        ...
        final double dividend = Lambda * eSPow2;
        final double divisor = 2 * (1 - Ro1) * (1 - Ro2);
        return dividend / divisor;
    }
    ...
    public double D2T1(Map<SystemFeature, Double> features) {
        ...
        final double part3Dividend = Lambda * eSPow2;
        final double part3Divisor = 2 * (1 - Ro1);
        return D2S1 + part1Dividend / part1Divisor + part2Dividend / part2Divisor + part3Dividend / part3Divisor;
    }
