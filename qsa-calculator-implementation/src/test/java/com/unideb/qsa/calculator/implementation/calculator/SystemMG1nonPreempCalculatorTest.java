...
public class SystemMG1nonPreempCalculatorTest {
    ...
    public void P0Test() {
        ...
        // WHEN
        double result = systemMG1nonPreempCalculatorUnderTest.P0(features);
        // THEN
        Assert.assertEquals(result, expected, DELTA);
    }
    ...
    public void ECostTest() {
        // GIVEN
        Map<SystemFeature, Double> features = createTestFeatures();
        double expected = 7.893000000000004;
        // WHEN
        double result = systemMG1nonPreempCalculatorUnderTest.ECost(features);
        // THEN
        Assert.assertEquals(result,expected,  DELTA);
    }
