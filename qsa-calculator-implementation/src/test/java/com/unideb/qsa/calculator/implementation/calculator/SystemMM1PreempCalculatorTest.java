...
public class SystemMM1PreempCalculatorTest {
    ...
    public void Edelta1Test() {
        // GIVEN
        Map<SystemFeature, Double> features = createTestFeatures();
        double expected = 11.1111111;
        // WHEN
        double result = systemMM1PreempCalculatorUnderTest.EDelta1(features);
        // THEN
        Assert.assertEquals(result, expected, DELTA);
    }
    ...
    public void ECostTest() {
        ...
        // WHEN
        double result = systemMM1PreempCalculatorUnderTest.ECost(features);
        // THEN
        Assert.assertEquals(result,expected,  DELTA);
    }
